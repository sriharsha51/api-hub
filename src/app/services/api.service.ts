...
export class APIService {
    ...
    private mailBoxLayer_API_URL: string = environment.MAILBOXLAYER_API_URL;
    private mailBoxLayer_API_KEY: string = environment.MAILBOXLAYER_API_KEY;
    ...
    private numVerify_API_URL: string = environment.NUM_VERIFY_API_URL;
    private numVerify_API_KEY: string = environment.NUM_VERIFY_API_KEY;
    private numVerify_URL: string = this.numVerify_API_URL + this.numVerify_API_KEY + '&number=';
    private format: string = '&format=1';

    private languageLayer_API_URL: string = environment.LANGUAGE_LAYER_API_URL;
    private languageLayer_API_KEY: string = environment.LANGUAGE_LAYER_API_KEY;
